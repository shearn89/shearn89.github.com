...
normalise IDs in the properties file.
...
up. This is where we tie it all together by normalising things!

## Nifi.properties Setup

We use normalisation rules in `nifi.properties` to get everything working. This
