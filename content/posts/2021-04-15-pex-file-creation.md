...
on [Pixabay](https://pixabay.com)_
...
that there's a change in Pex 2.1.46 that means you now require a shebang in
`main.py`. So if you do get odd behaviour, make sure it's there!
{{< /admonition >}}
